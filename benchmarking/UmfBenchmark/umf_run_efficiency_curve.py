...
# Internal imports
import multiphaseflowsr.physym.reward
from multiphaseflowsr.physym import execute as Exec
from multiphaseflowsr.physym import library as Lib
from multiphaseflowsr.physym import program as Prog

# Local imports
import umf_config as uconfig

BATCH_SIZE = uconfig.CONFIG["learning_config"]["batch_size"]
N_SAMPLES  = uconfig.N_SAMPLES
N_FREE_CONST_STEPS = uconfig.CONFIG["free_const_opti_args"]["method_args"]["n_steps"]
...
if __name__ == '__main__':
    ...
    multiphaseflowsr.physym.execute.SHOW_PROGRESS_BAR = True
    ...
    enabled = multiphaseflowsr.physym.reward.USE_PARALLEL_OPTI_CONST
    fig.suptitle("Efficiency curve: free const. opti.\n Using parallelization in multiphaseflowsr run : %s"%(str(enabled)))
    ...
    ax.legend()
    fig.savefig("umf_efficiency_curve.png")
